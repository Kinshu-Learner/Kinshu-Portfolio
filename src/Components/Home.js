    ...
    <div name='home' className='bg-gradient-to-b from-black via-black to-gray-800 h-screen '>
      ...
      <div className="max-w-screen-lg mx-auto flex flex-col h-full items-center justify-center px-4 md:flex-row">
        ...
        <div className='flex flex-col justify-center h-full x-sm:mt-40 md:mt-0'>
          ...
          <h2 className=' text-white text-4xl md:text-7xl text-bold py-4'>I'm a <span className='text-transparent bg-clip-text bg-gradient-to-tr from-indigo-500 to-purple-700'>Full Stack</span>  <span className='text-transparent bg-clip-text bg-gradient-to-tr from-cyan-500 to-blue-500'>Developer</span></h2>
